...
{
  "$end", "error", "$undefined", "GLOBALCMT", "SGLINECMT", "INDEX",
  "FILENAME", "TAKEBITS", "CMDNAME", "$accept", "commands", "command",
  "global_comment", "single_line_comment", "create_new_file",
  "generate_command", YY_NULL
};
#endif
